...
?> 如若遭遇服务器无法进入的情况，可以尝试更换线路进入。下面是「SoTap·Wonderland」的不同线路：  `play.sotap.org` *通用地址，第一推荐。*  `d2.toho.cloud:22003` *由服务商提供的优化地址。*  `bgp.d2.toho.cloud:22003` *由服务商提供的「阿里云八线 BGP 节点」优化地址。*  `hw.d2.toho.cloud:22003` *由服务商提供的「海外香港 CN2 节点」优化地址。*  
