...
### ItemsAdder 是个什么玩意？原版服务器怎么会有这么多新东西？
细心的玩家会发现服务器下载材质包时显示的插件为 ItemsAdder,没错，正是这个插件在服务器中加入了300+全新的自定义物品(~~给玩家带来极大的不便~~)扩展了原版游戏的内容。在游戏中输入`/ia`可以查看合成表。

附上 [ItemsAdder官方wiki](https://lonedev.gitbook.io/itemsadder/) 供玩家查阅。简明的教程可以查看**插件介绍**页面
