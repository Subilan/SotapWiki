...
### GHS会被ban吗？
在社区任何地方发布暴露的图片和 18🈲 露骨言语，第一次会被社区内所有群聊禁言 24H，第二次永 ban。
## 游戏相关
...
### 海底墓地是什么？怎么去？里面都是什么人？
海底墓地，位于 SoTap 主世界某一处珊瑚海的海底。那里有着众多的墓碑，还有很多空的墓穴等待着新的“尸体”来装填它的空洞。要前往神秘的海底墓地，只需要简单的输入指令`/warp grave`并支付一些传送费用即可瞬间到达。海底墓地埋葬着的，都是一些退服了的玩家还有因为违反规则而被永 ban 的玩家。每当有玩家退服或者被ban，我们都会在此为其树立一块墓碑，以此来证明他来过。同时他的墓碑上也会刻下其事迹来让后人观摩和警示自身。
...
SoTap 的规则和其他服务器不同的就是要求玩家自己来判断这样做会不会违规。在做一件事之前要三思，最重要的是站在对方的角度去思考。设想一下，如果你的机器被别人乱动了，你内心会开心吗？你破坏了别人的东西，这是道德所允许的吗？你拿了别人箱子里的东西，这是合情合理的吗？在做任何事情之前 ，先思考一番再做不是坏事情，不要用突破道德和贬低教养的标准来做一些事情，当一个人试图降低道德标准来做某件事情的时候，其实他自己**已经知道**自己违规了。
...
### 我可以申请在 ACT 服举办活动吗？
一些大型的活动，官方会启用专属的服务器为其举办。当然，如果玩家自发组织的活动规模比较大，也是可以向管理组申请征用 ACT 服务器的。在此之前，需要向管理组提交你的详细的活动策划。管理组会审核活动是否有必要启用 ACT 服，以及是否时间和其他在ACT服举办的活动相冲突。如果有两个活动的时间安排相冲突了，那么可能需要活动举办方自行调整日期或者开启多世界。
...
在聊天栏里输入 `[money]` 然后发出，别人将鼠标移动到这个字符上，就可以看到你有多少 coins 啦！
