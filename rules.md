...
服务器人数日渐增加，为了保证玩家的体验，服务器新增了几条规则。这些规则可能与国内很多服务器里常见的规则不同，需要玩家特别注意。

1. 主服开启玩家 pvp，但禁止恶意 pvp 与骚扰。
2. 不要破坏其他玩家的建筑、设施。如果你在主城区引爆了苦力怕，你有责任要恢复地形和建筑。
3. 没有注明公用的箱子一律视为私人箱子，无论它是不是上锁。擅自从这些箱子里面拿物品视为**偷窃**。
4. 没有注明公用的农场一律视为私人。请不要擅自收割这些农作物，即使你打算补种。而在注明公用的农场请必须补种。
...
9. 禁止使用**具有危害游戏公平性的**外挂、MOD 等任何非原生服务器提供的方法进行游玩等。
