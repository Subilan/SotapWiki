...
重要更新和通知会在[官方博客](https://blog.sotap.org)发布，例如每月平衡性调整。而例行维护、论坛升级等会在[更新日志](https://open.sotap.org)发布。游戏活动等的发布则会在论坛和 QQ 群体中发布、报名。而上述内容通常都会在 QQ 群中进行通知，因此我们建议你加入 QQ 群以更快更好的接收信息。
