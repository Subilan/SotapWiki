...
在出生点海岛上，你可以看到附近主城的地图，你可以选择使用海岛尽头的地狱传送门，前往地狱交通枢纽，并按牌子介绍前往你需要去的地方。你也可以选择直接游泳离开海岛。

为了还原原版游戏体验，玩家不能直接使用传送指令（如`/warp`、`/tpa`），你仍然可以使用`/spawn`回到出生点海岛上，因此当你找到合适的地方打算定居时，你可以使用`/sethome [家名字]`设置家，这样一来你以后就可以通过`/home [家名字]`直接传送回家。

?> 💡 `/spawn` 指令为可以免费使用的指令，而`/home`属于收费指令。<br>新人保护期间可以免费`/ehome [家名字]`（对应`/home [家名字]`指令）和`/esethome [家名字]`（对应`/sethome [家名字]`指令）。

在出生点海岛上，还有可以传送到不同地方的传送牌子，这些传送牌子可以通过交易购买，也是一种高速传送的好方法。

|  **牌子名称**  | **价钱** |                      **简介**                      |
| :------------: | :------: | :-: |
|    萌新之家    |    30    | 纯公益村落，帮助新手渡过困难的前期，详询村长@Kelegele |
|    SCP 总部    |    30    | SCP 基金会，玩家城镇，红石主题 |
| 叮咚小溪宠物点 |    10    | 叮咚小溪上面的宠物点，可以接任务和购买宠物币抽奖券 |
|  血盟玩家商场  |    3     | 位于血盟骑士团总部旁边的玩家商场 |
|    加州主城    |    50    | 玩家城镇，机场所在地，拥有高铁站 |
|   巴黎商业街   |    45    | 商业街有玩家设置的商店摊位，是赚钱的好地方 |
|    巴黎主城    |    45    | 主城，现代化都市，拥有高铁站，可在巴黎的 JD 商店出售农作物，玩家商店可以设置于巴黎商业街 |
|    楼兰古城    |    5     | 玩家城镇 |
|  红毛社轻轨站  |    1     | 玩家城镇红毛社内部设施 |
| 红毛社地狱枢纽 |    1     | 玩家城镇红毛社内部设施 |
|      柏林      |    10    | 玩家城镇 |
| 北方桃源 郊区  |    20    | 玩家城镇 |

另外，服务器还有不定期（一般为一周）重置的资源世界，主世界矿脉有部分已经开发过，相比之下资源世界矿量比较丰富。

?> 💡 资源世界指令为免费传送，如果想要免费传送回到主世界的话可以使用`/spawn`。
