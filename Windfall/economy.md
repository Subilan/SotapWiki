...
~~**薄荷币**是唯一可以在 SoTap 主服与其他子服之间互通的货币，在 Windfall 中**薄荷币**可以兑换成 Coins ，也可以用来兑换 mcMMO 等级。而 Windfall 也是唯一可以用 Coins 购买**薄荷币**的服务器。~~ *2020 年 7 月更新薄荷币功能*

薄荷币仅能通过活动奖励发放，用于兑换 Windfall 游戏内或游戏外到虚拟物品。具体兑换方式及可兑换物品，请参阅[薄荷币兑换奖励][4]。
