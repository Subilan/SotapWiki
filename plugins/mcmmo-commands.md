...
>? 除了上述方法外，你你也可以使用薄荷币购买McMMO单项技能的等级。另外，周末双倍经验和经验加速器也可以提高技能的经验提升。
...
### 修理 Repairs
修理是冶炼和分解的父级技能。这里的修理是指McMMO中使用铁砖进行的修理，与原版铁砧没有关系。使用铁砖进行修理**有机会保留**附魔。
#### 经验来源
...
##### 利刃突刺（主动能力）
持剑右击鼠标，并攻击生物或玩家以激活该技能。这会使小幅范围内的敌人受到+25%的伤害，并且叠加撕裂的伤害。
##### 剑术极限突破（100级解锁）
提高剑术伤害。
...
#### 能力
##### 野性呼唤（主动能力）
手持10根骨头或10条鱼或10个苹果按住<kbd>Shift</kbd>左击鼠标分别召唤狼，猫和马。被召唤的动物将会标有名字。被召唤的动物有可能会在一段时间后消失。
##### 嗜血
...
### 分解 Salvage
分解是钓鱼和修理的子技能，无法直接获得经验。

### 冶炼 Smelting 
冶炼是挖矿和修理的子技能，无法直接获得经验。
